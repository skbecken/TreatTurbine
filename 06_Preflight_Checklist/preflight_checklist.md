...
- [ ] SiK radio antenna has a clear view and is oriented correctly (pointed up in most conditions)
- [ ] Radio controller is adequately charged
- [ ] The autonomous flight path is valid
- [ ] Failsafe path and altitude are set correctly
...
- [ ] Takeoff/landing zone is clear (10ft radius with open sky)
- [ ] Good GPS lock (HDOP <1.2 and 8+ satellites)
- [ ] Battery is secure (passes wiggle test)
- [ ] Battery leads have tension and are not at risk of getting into props
...
- [ ] IMSAFE 
  ...
  - [ ] Fatigue
  - [ ] Emotion
- [ ] Adequate sunglasses/glasses for the distance and direction of flight
...
- [ ] Flight will not exceed visual line of site (or spotters are present along the way) without waiver
